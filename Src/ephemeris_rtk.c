...
//#pragma CODE_SECTION(var_uraeph,"sect_ECODE_II");
...
//#pragma CODE_SECTION(var_urassr,"sect_ECODE_II");
...
* notes  : see ref [1],[7],[8]
*-----------------------------------------------------------------------------*/
//#pragma CODE_SECTION(alm2pos,"sect_ECODE_II");
...
*-----------------------------------------------------------------------------*/
//#pragma CODE_SECTION(eph2clk,"sect_ECODE_II");
...
*          (tgd or bgd)
*-----------------------------------------------------------------------------*/
//#pragma CODE_SECTION(eph2pos,"sect_ECODE_II");
double dTemp = 0.0;
                    ...
                    double *var)
{
    ...
    *dts=eph->f0+eph->f1*tk+eph->f2*tk*tk;
	...
	dTemp = mu*eph->A;
	dTemp = sqrt(dTemp)*eph->e;
	dTemp = dTemp*sinE;
	dTemp = 2.0*dTemp/SQR(CLIGHT);
	*dts-= dTemp;
...
//#pragma CODE_SECTION(deq,"sect_ECODE_II");
...
//#pragma CODE_SECTION(glorbit,"sect_ECODE_II");
...
* notes  : see ref [2]
*-----------------------------------------------------------------------------*/
//#pragma CODE_SECTION(geph2clk,"sect_ECODE_II");
...
* notes  : see ref [2]
*-----------------------------------------------------------------------------*/
//#pragma CODE_SECTION(geph2pos,"sect_ECODE_II");
...
* notes  : see ref [3]
*-----------------------------------------------------------------------------*/
//#pragma CODE_SECTION(seph2clk,"sect_ECODE_II");
...
* notes  : see ref [3]
*-----------------------------------------------------------------------------*/
//#pragma CODE_SECTION(seph2pos,"sect_ECODE_II");
...
/* select ephememeris --------------------------------------------------------*/
//#pragma CODE_SECTION(seleph,"sect_ECODE_II");
...
//#pragma CODE_SECTION(selgeph,"sect_ECODE_II");
...
//#pragma CODE_SECTION(selseph,"sect_ECODE_II");
...
//#pragma CODE_SECTION(ephclk,"sect_ECODE_II");
...
//#pragma CODE_SECTION(ephpos,"sect_ECODE_II");
    ...
    *svh=-1;
    ...
    if (sys==SYS_GPS||sys==SYS_GAL||sys==SYS_QZS||sys==SYS_CMP) {
        ...
        *svh=eph->svh;
		...
		/*if(sys==SYS_GPS)
		{
			LOG_printf(&trace,"ephpos GPS %d",sat);
		}
		else if(sys==SYS_CMP)
		{
			LOG_printf(&trace,"ephpos BD %d",sat);
		}*/
    }
    else if (sys==SYS_GLO) {
        ...
        *svh=geph->svh;
		...
		//LOG_printf(&trace,"ephpos GLO %d",sat);
    }
    else if (sys==SYS_SBS) 
	{
        //if (!(seph=selseph(teph,sat,nav))) 
...
//#pragma CODE_SECTION(satpos_ssr,"sect_ECODE_II");
...
*-----------------------------------------------------------------------------*/
//#pragma CODE_SECTION(satpos,"sect_ECODE_II");
...
*-----------------------------------------------------------------------------*/
//#pragma CODE_SECTION(satposs,"sect_ECODE_II");
                    ...
                    int ephopt, double *rs, double *dts, double *var, int *svh)
{
    ...
    double dt,pr;
    int i,j;
	gtime_t temp_teph,temp_obstime;
...
//            LOG_printf(&trace,"no ephemeris sat=%d",obs[i].sat);
            continue;
        }
/*
//		LOG_printf(&trace,"obs sat %d",obs[i].sat);
		LOG_printf(&trace,"sat x %d",(int)*(rs+i*6));
		LOG_printf(&trace,"sat y %d",(int)*(rs+i*6+1));
		LOG_printf(&trace,"sat z %d",(int)*(rs+i*6+2));
		LOG_printf(&trace,"sat vx %d",(int)*(rs+i*6+3));
		LOG_printf(&trace,"sat vy %d",(int)*(rs+i*6+4));
		LOG_printf(&trace,"sat vz %d",(int)*(rs+i*6+5));
		LOG_printf(&trace,"sat dt %d",(int)(*(dts+i*2)*1e9));
		LOG_printf(&trace,"sat dts %d",(int)(*(dts+i*2+1)*1e9));
		*/
